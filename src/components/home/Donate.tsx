...
const Donate = () => {
  return (
    <div className='mobile:gap-[34px] mobile:px-[24px] mobile:py-[42px] tablet:gap-[40px] tablet:px-[80px] tablet:py-[60px] flex flex-col items-center justify-center gap-[20px] px-[16px] py-[34px]'>
      <h1 className='mobile:gap-[34px] mobile:text-[32px] tablet:text-[40px] text-center font-playfairDisplay text-[24px] font-bold'>
      ...
      <div className='mobile:flex-row mobile:gap-[24px] tablet:gap-[24px] flex flex-col items-center justify-center gap-[20px]'>
        <div>
          ...
          <div className='tablet:mb-[32px] tablet:gap-[16px] mb-[24px] flex flex-col items-start gap-[10px]'>
            <h1 className='tablet:text-[24px] font-playfairDisplay text-[20px] font-bold'>
        ...
        <div>
          <img src={Img100} alt='44' className='tablet:px-0 tablet:pb-[20px] px-[16px] pb-[24px]' />
          <div className='tablet:mb-[32px] tablet:gap-[16px] mb-[24px] flex flex-col items-start gap-[10px]'>
            <h1 className='tablet:text-[24px] font-playfairDisplay text-[20px] font-bold'>
