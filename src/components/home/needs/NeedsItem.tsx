...
const NeedsItem = ({ text, icon }: NeedsItemProps) => {
  return (
    <div className='group h-[195px] w-full rounded-md bg-gradient-to-b from-[rgb(248,253,2)] to-[rgb(79,134,242)] p-[2px] transition-transform duration-300 hover:scale-[1.02] md:h-[195px] md:w-[332px] xl:h-[256px] xl:w-[262px]'>
