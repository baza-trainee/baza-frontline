const MapEmbed = () => {
  ...
  return (
    <section className='mx-auto h-[160px] w-full max-w-[25rem] overflow-hidden rounded-md md:h-[220px] md:w-[420px] md:max-w-none lg:h-[266px] lg:w-[620px] xl:h-[321px] xl:w-[738px] 2xl:h-[368px] 2xl:w-[845px]'>
      <iframe
        src={mapSrc}
        width='100%'
        height='100%'
